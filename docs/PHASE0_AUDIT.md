...
> 历史说明：本文记录 v3.0.0 原生迁移前的目标与差距。v3.0.1 移除了 Radio/广播顶层页并曾以内嵌 WebView 展示博客；自 v3.0.3 起，Home 已改为不加载网页的原生 Compose 个人主页。当前实现契约以 [`ARCHITECTURE.md`](./ARCHITECTURE.md) 为准。
